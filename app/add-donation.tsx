...
export default function AddDonation() {
  ...
  const handleSave = () => {
    const amountValue = parseFloat(formatAmount(amountCents));
    const now = new Date();
    const monthNames = ['january','february','march','april','may','june','july','august','september','october','november','december'];
    addDonation({
      name: donorName || 'Anonymous',
      amount: amountValue,
      method: paymentMethods.find(m => m.id === selectedMethod)?.label || selectedMethod,
      date: now.toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' }),
      thankYouSent: false,
      isFavorite: false,
      comments,
      addedToSponsorList: addToSponsor,
    });
...
const styles = StyleSheet.create({
  ...
  handleBar: { width: 48, height: 4, backgroundColor: '#D1D5DB', borderRadius: 2, alignSelf: 'center', marginTop: 8, marginBottom: 16 },
  ...
  amountLabel: { fontSize: 11, fontWeight: '600', color: '#6a7282', letterSpacing: 0.55, textTransform: 'uppercase', marginBottom: 8 },
  ...
  numpadKey: { width: 88, height: 56, borderRadius: 14, backgroundColor: '#F9FAFB', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#E5E7EB' },
  ...
  fieldLabel: { fontSize: 11, fontWeight: '600', color: '#6a7282', letterSpacing: 0.55, textTransform: 'uppercase', marginBottom: 10, marginTop: 4 },
  inputRow: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: '#F9FAFB', borderRadius: 14, paddingHorizontal: 17, paddingVertical: 17, borderWidth: 1, borderColor: '#E5E7EB', marginBottom: 20 },
  inputIcon: { fontSize: 18 },
  textInput: { flex: 1, fontSize: 16, color: '#101828' },
  methodsScroll: { paddingBottom: 8, gap: 10, marginBottom: 8 },
  methodPill: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 20, paddingVertical: 12, borderRadius: 24, backgroundColor: '#F3F4F6', borderWidth: 1.5, borderColor: '#E5E7EB' },
  methodPillActive: { backgroundColor: '#4aa0c4', borderColor: '#4aa0c4', shadowColor: '#4aa0c4', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 6, elevation: 4 },
  methodEmoji: { fontSize: 16 },
  methodLabel: { fontSize: 15, fontWeight: '600', color: '#364153' },
  methodLabelActive: { color: 'white' },
  commentsInput: { backgroundColor: '#F9FAFB', borderRadius: 14, paddingHorizontal: 16, paddingVertical: 16, borderWidth: 1, borderColor: '#E5E7EB', fontSize: 16, color: '#101828', textAlignVertical: 'top', minHeight: 88, marginBottom: 20 },
  sponsorToggle: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, borderWidth: 2, borderStyle: 'dashed', borderColor: '#D1D5DB', borderRadius: 14, paddingVertical: 16, marginBottom: 20 },
  sponsorToggleActive: { backgroundColor: '#d6e4f5', borderStyle: 'solid', borderColor: '#4aa0c4' },
  sponsorHeart: { fontSize: 20, color: '#9CA3AF' },
  sponsorLabel: { fontSize: 15, fontWeight: '600', color: '#4a5565' },
  sponsorLabelActive: { color: '#1d3a6d' },
  saveBtn: { backgroundColor: '#4aa0c4', borderRadius: 14, paddingVertical: 18, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, shadowColor: '#4aa0c4', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.3, shadowRadius: 12, elevation: 6 },
  saveBtnCheck: { fontSize: 20, color: 'white' },
  saveBtnText: { fontSize: 18, fontWeight: '600', color: 'white' },
  confirmSheet: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 24, backgroundColor: 'white' },
  confirmClose: { position: 'absolute', top: 24, right: 24, width: 40, height: 40, borderRadius: 20, backgroundColor: '#F3F4F6', alignItems: 'center', justifyContent: 'center' },
  confirmCloseIcon: { fontSize: 16, color: '#6B7280' },
  successRing: { width: 120, height: 120, borderRadius: 60, backgroundColor: 'rgba(74,160,196,0.15)', alignItems: 'center', justifyContent: 'center', marginBottom: 28 },
  successCircle: { width: 96, height: 96, borderRadius: 48, backgroundColor: '#4aa0c4', alignItems: 'center', justifyContent: 'center' },
  successCheck: { fontSize: 44, color: 'white', fontWeight: '700' },
  confirmTitle: { fontSize: 28, fontWeight: '700', color: '#111', marginBottom: 8 },
  confirmSubtitle: { fontSize: 15, color: '#6B7280', textAlign: 'center', lineHeight: 22, marginBottom: 32, maxWidth: 280 },
  confirmDetails: { width: '100%', backgroundColor: '#F9FAFB', borderRadius: 16, padding: 20, marginBottom: 28 },
  confirmRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#F3F4F6' },
  ...
  doneBtn: { width: '100%', backgroundColor: '#4aa0c4', borderRadius: 14, paddingVertical: 18, alignItems: 'center', shadowColor: '#4aa0c4', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 4 },
